...
class Agent(agent.Agent):
    ...
    def _get_dynamic_uncertainty(self, dynamic):
    ...
    def _get_dynamic_dist(self, dynamic):
    ...
    def _get_dynamic_sensitivity(self, dynamic):
    ...
    def _dynamics_uncertainty_analysis(self, d_name, save_path, noise=0.1):
        if d_name is 'std':
    ...
    def _mopp_sol(self, observation, state=()):
...
class AgentModule(agent.AgentModule):
    """Tensorflow module for MOPP agent."""
